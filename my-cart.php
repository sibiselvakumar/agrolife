				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a style="background-color: #806a00;" href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
								<input style="background-color: #806a00;" type="submit" name="submit" value="Update shopping cart" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button style="background-color:#806a00;" type="submit" name="ordersubmit" class="btn btn-primary">PROCCED TO CHEKOUT</button>
