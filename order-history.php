...
<h3 style="background-color:#75640F;color:white;padding:24px;"> ORDER HISTORY </h3>
...
?>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
    <span style="background-color:#75640F;color: #fff;font-size: 14px;border-radius: 5px;padding: 10px 20px;text-align: center;cursor: pointer;">Track</span> </a>
                    </td>
                    <td>
                    	<a href="billscript.php?id=<?php echo $row['orderid']?>" target="_blank">
<button style="background-color: #821093;color: #fff;font-size: 14px;border-radius: 5px;padding: 10px 20px;text-align: center;cursor: pointer;">
  Invoice
</button>
  </a>
