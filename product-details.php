...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 style="color:#f9ff01" class="section-title">A2AGRO WELCOMES YOU</h3>
...
<section class="section featured-product wow fadeInUp">
	<h3 style="color:green" class="section-title">People also search for these, Would you like to buy</h3>
