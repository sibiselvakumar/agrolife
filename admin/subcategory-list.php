...
if(isset($_GET['del']))
		  {
                  ...
                  header('Refresh: 3; URL = subcategory-list.php');
		  }
					...
					<div class="content">
						...
						<div class="module">
							...
							<div style="background-color: green;" class="module-head">
								<h3 style="color:white;">Sub Category List</h3>
							</div>
...
?>									
										<tr>
											...
											<a href="subcategory-list.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i style="color:red;" class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
