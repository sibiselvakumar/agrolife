...
<?php $query=mysql_query("select * from album");
$cnt=1;
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['albumsize']);?></td>
                                            <td><a href="../<?php echo $row['path']; ?>"><img src="../img/download.png" width="100" height="100"></a></td>
											...
											<td>
											<a href="edit-album.php?id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
											</td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
